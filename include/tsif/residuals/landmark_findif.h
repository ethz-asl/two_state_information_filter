...
class LandmarkFlagMeasurement : public ElementVector<Element<bool,0>>{
 public:
  LandmarkFlagMeasurement() : ElementVector<Element<bool,0>>(false){};
  LandmarkFlagMeasurement(const bool& b) : ElementVector<Element<bool,0>>(b){};
...
using LandmarkFindifBase = Residual<ElementVector<Element<Vec3,Y>>,//innovation
                                    ...
                                    LandmarkFlagMeasurement>;//measurement

//prediction residual comparing current landmark position with 
template<int B_V_IB,int B_OMEGA_IB,int B_P>
class LandmarkFindif : public LandmarkFindifBase<0,B_V_IB,B_OMEGA_IB,B_P> {
 public:
  //typedef and types from base for convenience
  //base type
  typedef LandmarkFindifBase<0,B_V_IB,B_OMEGA_IB,B_P> Base;
  ...
  LandmarkFindif(): Base (true,//splittable
                          true,//mergeable
                          true),//mandatory
