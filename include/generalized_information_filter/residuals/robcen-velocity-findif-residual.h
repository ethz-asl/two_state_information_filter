#ifndef GIF_ROBCENVELOCITYFINDIFRESIDUAL_HPP_
#define GIF_ROBCENVELOCITYFINDIFRESIDUAL_HPP_
 ...
 */
class RobcenVelocityFindifResidual
 ...
 public:
  using mtResidual = BinaryResidual<ElementPack<Vec3>, ElementPack<Vec3, Vec3, Quat>,
                                    ElementPack<Vec3>, ElementPack<Vec3>, EmptyMeas>;
  RobcenVelocityFindifResidual(const std::string& name,
  ...
  virtual ~RobcenVelocityFindifResidual() {
  }
...
#endif /* GIF_ROBCENVELOCITYFINDIFRESIDUAL_HPP_ */
