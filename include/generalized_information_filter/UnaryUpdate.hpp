...
class UnaryUpdate<ElementPack<Inn...>,ElementPack<Sta...>,ElementPack<Noi...>,Meas>:
    public BinaryResidual<ElementPack<Inn...>,ElementPack<>,ElementPack<Sta...>,ElementPack<Noi...>,Meas>{
 public:
  typedef UnaryUpdate<ElementPack<Inn...>,ElementPack<Sta...>,ElementPack<Noi...>,Meas> mtUnaryUpdate;
  typedef BinaryResidual<ElementPack<Inn...>,ElementPack<>,ElementPack<Sta...>,ElementPack<Noi...>,Meas> mtBinaryRedidual;
  UnaryUpdate(const std::array<std::string,ElementPack<Inn...>::n_>& namesInn,
              ...
              const std::array<std::string,ElementPack<Noi...>::n_>& namesNoi):
               mtBinaryRedidual(namesInn,  std::array<std::string,0>(), namesSta, namesNoi, true, false, false){};
  virtual ~UnaryUpdate(){};

  // User implementations
  virtual void evalUnaryUpdateImpl(Inn&... inn, const Sta&... sta, const Noi&... noi) const = 0;
  virtual void jacStaUnaryUpdateImpl(MXD& J, const Sta&... sta, const Noi&... noi) const  = 0;
  virtual void jacNoiUnaryUpdateImpl(MXD& J, const Sta&... sta, const Noi&... noi) const  = 0;

 protected:
  // Wrapping from BinaryResidual to UnaryUpdate implementation
  void evalResidualImpl(Inn&... inn, const Sta&... sta, const Noi&... noi) const{
